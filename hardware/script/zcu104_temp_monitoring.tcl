...
#
# zcu104_temp_monitoring.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Wed Jul 15 23:55:39 CEST 2026
...
#
# 1. This project restoration tcl script (zcu104_temp_monitoring.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/snke/fpga_work/project_1/project_1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../fpga_work/project_1/project_1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../fpga_work/ips/ip_repo/temperature_mock_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "zcu104_temp_monitoring.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../fpga_work/project_1"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../fpga_work/ips/ip_repo/temperature_mock_1_0"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:temperature_mock:1.0\
  "
...
\
  ...
  # Create instance: temperature_mock_0, and set properties
  set temperature_mock_0 [ create_bd_cell -type ip -vlnv user.org:user:temperature_mock:1.0 temperature_mock_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins temperature_mock_0/S_AXI]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins temperature_mock_0/s_axi_aresetn]
  connect_bd_net -net temperature_mock_0_irq [get_bd_pins temperature_mock_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins temperature_mock_0/s_axi_aclk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs temperature_mock_0/S_AXI/S_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-533,-232",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port led_4bits -pg 1 -lvl 4 -x 1240 -y 180 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 350 -y 90 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1110 -y 180 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 830 -y 170 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -x 350 -y 510 -defaultsOSRD
preplace inst temperature_mock_0 -pg 1 -lvl 3 -x 1110 -y 320 -defaultsOSRD
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 2 680 350 1000
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 180 670 340 990
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 190 660
preplace netloc temperature_mock_0_irq 1 0 4 40 400 NJ 400 NJ 400 1220
preplace netloc axi_gpio_0_GPIO 1 3 1 N 180
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 N 160
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 60
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 80
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 980 180n
levelinfo -pg 1 0 350 830 1110 1240
pagesize -pg 1 -db -bbox -sgen 0 0 1360 610
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../fpga_work/project_1/project_1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
